...
cc.Class({
    ...
    onLoad: function () {
      ...
      //   this.cn.on('mouseup',this.cnms_up,this);
         ...
         this.initpuker();
         this.mszb=null;
          this.runCount(this.updatetime,this);
     ...
     tishibt_down:function () {
      ...
      cnms_up:function (event) {
               if(this.xuowei!=this.sunxu&&this.state==4){
                  return;
               }
     ...
     initpuker: function () {
          ...
          this.numarr[2].string='倍数：1';
          this.numarr[3].string='底分：100';
          this.numarr[4].string='时间：20';
    ...
    msgCHuli:function(data) {
        ...
        this.nextinitpuker();
         ...
         if(data.msg.state==2){  //叫地主 
             ...
             this.numarr[2].string='倍数：'+data.msg.data.beishu;
             if(this.xuowei==this.sunxu){
                   if(this.xingwei==1){
                        this.jiaofen.active=true;
                   }else{
    ...
    updatetime:function(self){
            ...
            self.numarr[4].string='时间：'+ self.time;
          //  self.runCount(self.updatetime,self); 
            setTimeout(function(){self.updatetime(self);},1000); 
    },
    runCount:function(f,self){  
              setTimeout(function(){f(self);},1000); 
